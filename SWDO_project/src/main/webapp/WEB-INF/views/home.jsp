...
<section class="row" style="display: flex;justify-content: center;padding-top: 3em">
	<div id="grid">
		<form action="/product/productSearch" method="post" id="userImageUpload" enctype="multipart/form-data">
			<input type="file" id="upload" name="upload" onchange="userImageUpload()" style="display: none;">
			<button type="button" class="" id="btn-upload" style="background-color: white;">
            	<img alt="" src="/resources/img/mushroom_question_mark.jpg" style="width:150px;height:auto;">	 	
			</button>
		</form>	
		<div style="display: flex; justify-content: center;">
			<span style="font-size: xx-small;">당신의 버섯을 확인하세요</span>
		</div>
	</div>
</section>
