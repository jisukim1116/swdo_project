		...
		<form action="/board/boardWrite" method = "post" enctype="multipart/form-data">
			<div style="display: flex;justify-content: center;">
				<table class="table" style="table-layout:fixed;width:50%;" >
					<tr>
						<th>제목</th>
						<td style="width: 80%"><input type ="text" name = "board_title" value="${boardDetail.board_title }"> </td>
					</tr>
					<tr>
						<th>작성자</th>
					...
					<tr>
						...
						<td style="width: 80%;height: 10em">
							<textarea style="width:100%;height:100%;resize: none" name="board_content">${boardDetail.board_content }</textarea>
						</td>
					</tr>
					<tr>
						<th>조회수</th>
			...
			<div style="display: flex;justify-content: center;margin-bottom: 4em">
				<div style="display: flex;justify-content: flex-end; width: 50%">		
					<div>
						<input type="submit" value="수정완료" style="height:2em;width:6em;"> 
					</div>
				</div>
			</div>
		</form>
