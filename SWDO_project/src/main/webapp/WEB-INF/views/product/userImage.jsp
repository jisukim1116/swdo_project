...
<!-- google login logout 관련 js를 받아옴 -->
...
<section class="row" style="display: flex;justify-content: center;padding-top: 3em">
	<div id="grid">
		<div style="display: flex; justify-content: center;">
			<span style="font-size: small;">당신의 버섯은 "${PredictedClassName}" 입니다</span>
		</div>
		<div style="display: flex; justify-content: center;">
			<span style="font-size: small;">일치 확률은 "${PredictedClassScore}"  </span>
		</div>
	</div>
</section>
